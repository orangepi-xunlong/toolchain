/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/home/tcwg-buildslave/workspace/tcwg-make-release_1/snapshots/gcc.git~linaro-7.4-2019.02/gcc/config/aarch64/aarch64.md'.  */
